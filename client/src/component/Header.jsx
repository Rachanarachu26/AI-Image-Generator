...
const Header = () => {
  ...
  return (
    ...
    >
     ...
     gap-2 bg-white px-6 py-1 rounded-full border-neutral-500' 
    ...
    >
     ...
     sm:max-w-[590px] mx-auto mt-10 text-center'>Turn Text to <span className='text-blue-600'
   initial={{opacity:0}}
    animate={{opacity:1}}
     ...
     >Unleash your creativity with AI. Turn your imagination into visual art in seconds- just
      ...
      className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((item,index)=>(
          ...
          duration-300 cursor-pointer max-sm:w-10'src={index % 2==0 ? 
